...
import seederData from "./payrolls.seeder.json";
...
const PayrollsSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(PayrollsSeederDialogComponent);
