...
import PayrollsFakerDialogComponent from "./PayrollsFakerDialogComponent";
import PayrollsSeederDialogComponent from "./PayrollsSeederDialogComponent";
...
const PayrollsPage = (props) => {
    ...
    const deleteRow = async () => {
        try {
            await client.service("payrolls").remove(data[selectedEntityIndex]?._id);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <div className="col flex justify-content-end">
                    <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="payrolls-add-button"/>
            ...
            <div className="grid col-10">
                <div className="col-12" role="payrolls-datatable">
            ...
            <PayrollsFakerDialogComponent show={showFakerDialog} onHide={() => setShowFakerDialog(false)} onFakerCreateResults={onFakerCreateResults} />
            <PayrollsSeederDialogComponent show={showSeederDialog} onHide={() => setShowSeederDialog(false)} onSeederResults={onSeederResults} />
        </div>
    );
};
