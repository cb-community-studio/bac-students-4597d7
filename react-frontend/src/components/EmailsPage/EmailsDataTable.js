...
const EmailsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            <Column field="fromEmail" header="From Email" body={pTemplate0} style={{ minWidth: "8rem" }} />
            <Column field="toEmail" header="To Email" body={pTemplate1} style={{ minWidth: "8rem" }} />
            <Column field="subject" header="Subject Email" body={pTemplate2} style={{ minWidth: "8rem" }} />
            <Column field="body" header="Body" body={pTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="time" header="Time" body={pTemplate4} style={{ minWidth: "8rem" }} />
            <Column field="sentStatus" header="Sent Status" body={tickTemplate5} style={{ minWidth: "8rem" }} />
            <Column field="readStatus" header="Read Status" body={tickTemplate6} style={{ minWidth: "8rem" }} />
